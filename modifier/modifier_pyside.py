...
def wrapinstance(*args, **kwargs):
    try:
        ...
        raise ImportError('This method can not be executed without shiboken module.\n{0}'.format(e))
...
original_event_init = QtCore.QEvent.__init__


@qt_modifier.register('QtCore.QEvent.__init__')
def event_init(self, event):
    original_event_init(self, QtCore.QEvent.Type(event))
...
@qt_modifier.register('QtGui.QWidget.setFocusPolicy')
